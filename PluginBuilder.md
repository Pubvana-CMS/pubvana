...
**1. Use existing `cls_*` variables** - The theme system defines a complete vocabulary of standard classes. Use these for standard UI elements. The full list is below — use `{{ cls_name | default('semantic-default') }}` in your templates.
...
| Variable | Semantic Default | Used For |
|----------|-----------------|----------|
| `cls_h1`–`cls_h6` | `heading-1`–`heading-6` | Headings 1–6 |
