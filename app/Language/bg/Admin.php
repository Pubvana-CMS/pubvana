...
return [
    ...
    'addonMisconfiguredLink'    => '{0} е неправилно конфигуриран. Ако сте крайният потребител, <a href="{1}">свържете се с разработчика</a>. Ако сте разработчикът, <a href="https://github.com/Pubvana-CMS/pubvana">вижте документацията</a>.',
