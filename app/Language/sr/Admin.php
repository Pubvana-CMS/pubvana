...
return [
    ...
    'addonMisconfiguredLink'    => '{0} је неправилно конфигурисан. Ако сте крајњи корисник <a href="{1}">контактирајте програмера</a>. Ако сте програмер <a href="https://github.com/Pubvana-CMS/pubvana">консултујте документацију</a>.',
