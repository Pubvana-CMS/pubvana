...
return [
    ...
    'addonMisconfiguredLink'    => '{0} সঠিকভাবে কনফিগার করা হয়নি। আপনি যদি শেষ ব্যবহারকারী হন <a href="{1}">ডেভেলপারের সাথে যোগাযোগ করুন</a>। আপনি যদি ডেভেলপার হন <a href="https://github.com/Pubvana-CMS/pubvana">ডকুমেন্টেশন দেখুন</a>।',
