...
return [
    ...
    'widgetBlockedMalicious' => '{0} отмечен как вредоносный и не может быть добавлен.',
    'licenseNoStoreProduct'  => 'Этот элемент не связан с продуктом магазина. Если вы приобрели этот элемент, переустановите его из маркетплейса для активации лицензирования.',
    ...
    'addonMisconfiguredLink'    => '{0} настроен неправильно. Если вы конечный пользователь, <a href="{1}">обратитесь к разработчику</a>. Если вы разработчик, <a href="https://github.com/Pubvana-CMS/pubvana">обратитесь к документации</a>.',
