...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <input type="hidden" name="media_id" id="featured_media_id" value="<?= esc($post->media_id ?? '') ?>">
                <div id="featured-image-preview" class="mb-2" style="<?= $post->featured_image ? '' : 'display:none' ?>">
