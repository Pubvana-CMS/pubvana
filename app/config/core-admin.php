...
$adext->register('admin.settings', 'email', 'pubvana.cms.mail', [
    ...
    'fields'      => [
        ...
        [
            ...
            'type'        => 'number',
            'default'     => 587,
            'description' => '465 = SSL, 587 = STARTTLS, 25 = plaintext. Your host usually states the port; if it does not say which, 587 is the common default.',
        ],
        [
            'key'         => 'Mail.encryption',
            'label'       => 'Encryption',
            'type'        => 'select',
            'options'     => [
                'none' => 'None (plaintext, port 25)',
                'tls'  => 'TLS (STARTTLS, port 587)',
                'ssl'  => 'SSL (implicit, port 465)',
            ],
            'default'     => 'tls',
            'description' => 'Matches the SMTP port your host gave you: 465 uses SSL, 587 uses STARTTLS. If your host is unusual, pick what it asks for.',
        ],
        [
            'key'         => 'Mail.username',
            'label'       => 'SMTP Username',
