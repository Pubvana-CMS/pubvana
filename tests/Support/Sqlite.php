...
final class Sqlite
{
    ...
    private static function createSchema(PDO $pdo): void
    {
        ...
        /*
         * Store products. Final column shapes after the release rework,
         * per-tier sale pricing, and item_type/folder drops.
         */
        $pdo->exec(
            "CREATE TABLE store_products (
                ...
                single_sale_ends   TEXT,
                price_multi_site   REAL,
                multi_sale_price   REAL,
                multi_sale_starts  TEXT,
                multi_sale_ends    TEXT,
        ...
        $pdo->exec(
            "CREATE TABLE store_product_releases (
                id               INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        $pdo->exec(
            "CREATE TABLE store_licenses (
                ...
                scope              TEXT NOT NULL DEFAULT 'single_site',
